...
They can score points under the following conditions:
    ...
    -If players roll 3 dice of the same value, they score 100 times the value of the dice.
        ex. If a player rolls 4,4,4,2,6 , they score 100 * 4
    -If players roll 4 dice of the same value, they score 100 times the value of the dice times 2.
